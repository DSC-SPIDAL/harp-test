...
public class Workers extends Nodes {
   ...
   * Assign IDs to workers;
   * Master is the worker with ID 0;
  ...
  /**
   * Check if this is the only worker
   * or not
   ...
   * @return true if this worker is in 
   * 	the workers, false otherwise
   */
  ...
  /**
   * Check if the ID of this worker is
   * the maximum among all the workers
  ...
  /**
   * Get the WorkerInfo of the 
   * next worker
   * @return the WorkerInfo of the
   * 	next worker
   */
